...
namespace NJG.Utilities
{
    public static class Vector3Extensions
    {
        ...
        public static Vector3 WithX(this Vector3 self, float newX) => new(newX, self.y, self.z);

        public static Vector3 WithY(this Vector3 self, float newY) => new(self.x, newY, self.z);

        public static Vector3 WithZ(this Vector3 self, float newZ) => new(self.x, self.y, newZ);
