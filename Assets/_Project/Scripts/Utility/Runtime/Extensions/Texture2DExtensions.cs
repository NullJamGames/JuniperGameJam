...
namespace NJG.Utilities
{
    ...
    ///     including filling, dimension retrieval, and boundary checking.
    /// </summary>
    public static class Texture2DExtensions
    {
        ...
        public static Vector2Int GetDimensions(this Texture2D self) => new(self.width, self.height);
        ...
        /// <summary>
        ///     Test to see if texture dimensions contain point (`x`, `y`)
        /// </summary>
